    ...
    <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        <div class="flex items-center justify-between">
            <a class="flex flex-row" href="#">
                <img class="w-auto h-6 sm:h-7" src="https://leetcode.com/static/images/LeetCode_logo_rvs.png" alt="">
        ...
        <div class={(isOpen ? "translate-x-0 opacity-100": "opacity-0 -translate-x-full") + " translate-x-0 opacity-100 absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center"}>
